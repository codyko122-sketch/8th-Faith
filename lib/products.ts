...
export const COSMETICS: Cosmetic[] = [
  ...
  { id: "mediheal-dna-proatin-mask", brand: "메디힐", name: "디엔에이 프로아틴 마스크", category: "마스크팩", ingredients: ["하이드롤라이즈드콜라겐", "세라마이드", "아세틸헥사펩타이드-8", "판테놀"], forTypes: ["건성", "중성", "복합"], concerns: ["수분", "주름"], rating: 4.4, feel: "촉촉", desc: "수분단백질·세라마이드로 속건조를 케어하고 탄력을 채우는 보습 시트 마스크", fullMl: 25, price: 2000, safety: [], oliveYoungUrl: "https://www.oliveyoung.co.kr/store/search/getSearchMain.do?query=" + encodeURIComponent("메디힐 디엔에이 프로아틴 마스크"), linkType: "search" },
  { id: "drg-red-blemish-soothing-mask", brand: "닥터지", name: "레드 블레미쉬 딥 수딩 마스크", category: "마스크팩", ingredients: ["병풀추출물", "마데카소사이드", "판테놀", "히알루론산", "알란토인"], forTypes: ["민감", "복합", "지성"], concerns: ["트러블", "수분"], rating: 4.7, feel: "진정", desc: "시카 콤플렉스로 예민해진 피부를 진정시키는 수분 진정 시트 마스크", fullMl: 30, price: 3000, safety: ["약산성", "저자극"], oliveYoungUrl: "https://www.oliveyoung.co.kr/store/search/getSearchMain.do?query=" + encodeURIComponent("닥터지 레드 블레미쉬 딥 수딩 마스크"), linkType: "search" },
