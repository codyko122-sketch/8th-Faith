...
export type DailyWx = { dateISO: string; temp: number; humidity: number; uv: number; dust: number };
...
export async function fetchWeather(
  ...
  try {
    const url =
      ...
      `&daily=temperature_2m_max,uv_index_max&hourly=relative_humidity_2m&timezone=auto` +
